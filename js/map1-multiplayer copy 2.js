...
/////////////////////////////////////////////////////////////////////////
    ...
    function loadSamuraiModel() {
        samuraiLoader.load(
            ...
            (model) => {
                ...
                loadSamuraiAnimation('run.fbx');
                loadSamuraiAnimation('death.fbx');
                loadSamuraiAnimation('Taking Item.fbx');
                loadSamuraiAnimation('Victory.fbx');
    ...
    function loadSamuraiAnimation(animationPath) {
        samuraiLoader.load(
            `../Models/Animation/Samurai/${animationPath}`,
            (anim) => {
                const clip = anim.animations[0];
                const action = samuraiMixer.clipAction(clip);
                samuraiMixer.addAction(action);
            },
            (xhr) => {
